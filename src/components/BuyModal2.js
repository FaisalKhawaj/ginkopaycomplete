    ...
    return (
        ...
        >
            <View style={styles.mainview}>
                ...
                <HeaderBackTextClose text="Purchase Method 2" setShowBannerModal={setVisible} closeModal={setVisible} />
                ...
                <View style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
                 ...
                 <View style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
                    <Text style={{color:"#fff", fontFamily:boldtext}}>Sort code</Text>
                    <Text style={{color:graycolor, fontFamily:simpletext}}>23-14-70</Text>
                </View>
                <View style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
                 ...
                 <View style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
                    ...
                    <Text style={{color:graycolor, fontFamily:simpletext}}> TransferWise{"\n"} 56 Shoreditch High Street{"\n"} London , E1 6JJ{"\n"} United Kingdom</Text>
                </View>
                <View style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
