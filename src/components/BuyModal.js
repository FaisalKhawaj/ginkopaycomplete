...
const AssetsModal = ({visible, setVisible,setBuyModal11}) => {
    return (
        <Modal 
            isVisible={visible}
        ...
        >
            <View style={styles.mainview}>
                ...
                <TouchableOpacity onPress={() => {setBuyModal11()}} style={{width:width-60,marginTop:20, paddingHorizontal:30, alignSelf:"center"}}>
